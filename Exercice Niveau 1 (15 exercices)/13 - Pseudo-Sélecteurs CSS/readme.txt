...
Travail à faire :
1) Changer la taille du titre à "1.5em" en affichant la première lettre de chaque mot en capitale. x

2) Enlever la bordure pour le tableau. x

3) Ajouter une marge interne de 10px et un alignement centré pour tous les cellules "th et td". x

4) Cibler  la deuxième balise "th" de la première "tr" qui contient le mois du planning pour lui changer la taille en "2em" et la couleur en bleu. x

5) Mettre en  background "#FCB941"  tous lignes "tr" du tbody qui viennent en positions paires et en background "#F1654C" les lignes qui viennent en positions impaires (Utiliser le pseudo classe "nth-child").x

6) Donner à la première cellule de chaque ligne en position impaire ,un background "#7E3661" et une couleur "#fff".(Utiliser les pseudo classes nth-child et first-child) x

7) Donner à la première cellule de chaque ligne en position paire ,un background "#888888" et une couleur "#fff".(Utiliser les pseudo classes nth-child et first-child) x

8) Donner à la dernière cellule de chaque ligne en position impaire ,un background "#8870FF" et une couleur "#fff".(Utiliser les pseudo classes nth-child et last-child) x
